...
extension CustomPresentationRouter: Router {
    ...
    private func presentCustom(_ viewController: UIViewController, animated: Bool) {
        ...
        //вью контроллер содержит слабую ссылку на транзишн делегейт и когда мы инициализируем наш траншишн делегейт в слабой ссылке
        //на него нет сильных ссылок и он не останется в памяти
